...
-- Water Well --
	...
	{	
		{
			Material = "Nails", Amount = 10, Text = getItemNameFromFullType("Base.Nails"),
		},
		
		{
			Material = "Rope", Amount = 5, Text = getItemNameFromFullType("Base.Rope"),
		},
		
		{
			Material = "Plank", Amount = 5, Text = getItemNameFromFullType("Base.Plank"),
		},	
		
		{
			Material = "Gravelbag", Amount = 2, Text = getItemNameFromFullType("Base.Gravelbag"),
		},		
		
		{
			Material = "BucketEmpty", Amount = 1, Text = getItemNameFromFullType("Base.BucketEmpty"),
		},
	}
...
-- Fridge --
	...
	{
		{
			Material = "SheetMetal", Amount = 4, Text = getItemNameFromFullType("Base.SheetMetal"),
		},
        
		
		{
			Material = "Screws", Amount = 5, Text = getItemNameFromFullType("Base.Screws"),
		},
		
		{
			Material = "ElectricWire", Amount = 2, Text = getItemNameFromFullType("Radio.ElectricWire"),
		},
        
        {
			Material = "ElectronicsScrap", Amount = 10, Text = getItemNameFromFullType("Base.ElectronicsScrap"),
		},
	}
...
-- Barbecue --
	...
	{
		{
			Material = "SheetMetal", Amount = 2, Text = getItemNameFromFullType("Base.SheetMetal"),
		},
		
		{
			Material = "Screws", Amount = 3, Text = getItemNameFromFullType("Base.Screws"),
		},
		
		{
			Material = "Plank", Amount = 2, Text = getItemNameFromFullType("Base.Plank"),
		},
	}
...
-- Generator --
		...
		MoreBuild.neededMaterials =
	{
		...
		{
			Material = "Aluminum", Amount = 10, Text = getItemNameFromFullType("Base.Aluminum"),
		},
		...
		{
			Material = "Screws", Amount = 10, Text = getItemNameFromFullType("Base.Screws"),
		},
		
		{
			Material = "ElectronicsScrap", Amount = 100, Text = getItemNameFromFullType("Base.ElectronicsScrap"),
		},
	}
...
-- Fireplace --
	...
	{
		{
			Material = "SheetMetal", Amount = 6, Text = getItemNameFromFullType("Base.SheetMetal"),
		},
		
		{
			Material = "Nails", Amount = 20, Text = getItemNameFromFullType("Base.Nails"),
		},
	...
	{
		{
			Material = "Stone", Amount = 10, Text = getItemNameFromFullType("Base.Stone"),
		},

		{
			Material = "Dirtbag", Amount = 1, Text = getItemNameFromFullType("Base.Dirtbag"),
		},

		{
			Material = "BucketWaterFull", Amount = 1, Text = getItemNameFromFullType("Base.BucketWaterFull"),
		},
