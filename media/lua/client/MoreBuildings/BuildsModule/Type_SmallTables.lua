...
MoreBuild.getLargeTableData = function()
	local _largeTableData =
	{
		...
		{ "furniture_tables_high_01_35", "furniture_tables_high_01_34", "furniture_tables_high_01_32", "furniture_tables_high_01_33", getText "Tooltip_bangongshitip", },
		...
		{ "furniture_tables_high_01_45", "furniture_tables_high_01_44", "furniture_tables_high_01_46", "furniture_tables_high_01_47", getText "Tooltip_chuftip", },
		{ "furniture_tables_high_01_51", "furniture_tables_high_01_50", "furniture_tables_high_01_48", "furniture_tables_high_01_49", getText "Tooltip_chucunyunshutip", },
		{ "furniture_tables_high_01_53", "furniture_tables_high_01_52", "furniture_tables_high_01_54", "furniture_tables_high_01_55", getText "Tooltip_chucunyunshutip", },
		{ "furniture_tables_high_01_57", "furniture_tables_high_01_56", "furniture_tables_high_01_58", "furniture_tables_high_01_59", getText "Tooltip_chucunyunshutip", },

		{ "furniture_tables_low_01_15", "furniture_tables_low_01_14", "furniture_tables_low_01_0", "furniture_tables_low_01_1", getText "Tooltip_chajishafatip", },
	}
...
MoreBuild.missingPostsMenuBuilder = function(subMenu, player)
	...
	{
		{
			Material = "Log",
			Amount = 1,
			Text = getItemNameFromFullType("Base.Log"),
		},
	...
	_tooltip = MoreBuild.canBuildObject(MoreBuild.skillLevel.logObject, MoreBuild.skillLevel.none, _option, player)
	_tooltip:setName(_name)
	...
	MoreBuild.neededMaterials =
	{
...

		{
			Material = "SheetRope",
			Amount = 2,
			Text = getItemNameFromFullType("Base.SheetRope"),
		},
	}
