...
function ISUILuaWindow:initialise()
  ...
  self.goButton = ISButton:new(499, 250, 51, 22, 'Go', self, function() ISUILuaWindow.portLua() end)
...
function LuaWindowCreate() -- basic UI setup
  ISUILuaWindow = ISUILuaWindow:new(getCore():getScreenWidth() - 1050, getCore():getScreenHeight() - 350, getCore():getScreenWidth() - 1050, getCore():getScreenHeight() - 650)
